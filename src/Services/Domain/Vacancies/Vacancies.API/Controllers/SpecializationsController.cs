...
namespace Vacancies.API.Controllers
{
    ...
    public class SpecializationsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromBody]DtoVacancySpecialization dto)
        {
        ...
        public async Task<IActionResult> Update([FromBody]DtoVacancySpecialization dto, [FromRoute]long id)
        {
